...
/* The render comes on its own pale ground rather than cut out, so it is framed as a
   picture instead of being left as a bright rectangle floating on a dark page. */
.portrait img { display:block; width:100%; height:auto; border-radius:14px;
